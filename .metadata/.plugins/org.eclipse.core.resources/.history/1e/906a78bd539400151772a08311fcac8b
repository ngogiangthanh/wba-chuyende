				...
				<div class="row">
					<!-- BEGIN CONTENT -->
						...
						<div class="panel-heading">
							<i class="glyphicon glyphicon-th-list"></i>&nbsp;Lập danh sách sinh viên bị cảnh cáo học vụ
						</div>
						<div class="panel-body">
							...
							<div class="table-responsive">
								<table class="table table-bordered text-center">
									<thead>
									<tr>
										<td colspan="8" class="well">Danh sách sinh viên bị cảnh cáo học vụ - Năm học:&nbsp;${current_nk}&nbsp;-&nbsp;Học kỳ:&nbsp;${current_hk}
										<br/>
