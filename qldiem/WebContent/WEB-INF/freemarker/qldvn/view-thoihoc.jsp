	...
	<div class="container">
				...
				<div class="row">
					<!-- BEGIN CONTENT -->
						...
						<div class="panel-heading">
							<i class="glyphicon glyphicon-th-list"></i>&nbsp;Lập danh sách sinh viên bị buộc thôi học
						</div>
						<div class="panel-body">
							...
							<div class="table-responsive">
								<table class="table table-bordered text-center">
									<thead>
									<tr>
										<td colspan="7" class="well">Danh sách sinh viên bị buộc thôi học - Năm học:&nbsp;${current_nk}&nbsp;-&nbsp;Học kỳ:&nbsp;${current_hk}
										<br/>
									...
									<tr>
										...
										<th class="text-center info">Chuyên ngành</th>
									</tr>
									</thead>
									<tbody>
									<#if dsSVThoiHoc?? & dsSVThoiHoc?size gt 0 >
											<#list dsSVThoiHoc as sv>
												<tr>
													<td>${sv.stt}</td>
													<td>${sv.mssv}</td>
													<td>${sv.ho_ten}</td>
									...
									<#else>
										<tr>
											<td colspan="7">
												Không có sinh viên nào bị buộc thôi học.
											</td>
										</tr>
									</#if>
									</tbody>	
		...
		<div class="row" id="display_print">
			<table
				...
				<tr>
					...
					<td>
						<p>
						<h4>
							<strong>DS SINH VIÊN BỊ BUỘC THÔI HỌC</strong>
						</h4>
						</p>
					</td>
				</tr>
			...
			<table class="col-sm-12 col-xs-12 col-md-12 col-lg-12 pull-right ">
				...
				<tr class="">
					<td>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;Sinh viên bị buộc thôi học là sinh viên có điểm trung
					 bình 2 học kỳ liên tiếp (không tính học kỳ 3 - hè) dưới &lt;= 0.8</td>
				</tr>
			</table>
			<div class="clearfix">&nbsp;</div>
			<div class="clearfix">&nbsp;</div>
